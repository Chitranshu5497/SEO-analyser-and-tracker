...
export default function Report() {
    ...
    if (error || !analysis) {
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="relative text-center bg-card border border-danger/20 rounded-2xl p-10 shadow-[0_0_35px_-10px_rgba(239,68,68,0.35)] overflow-hidden">
                    <div className="absolute -top-16 -right-16 w-40 h-40 bg-danger/15 blur-[60px] rounded-full pointer-events-none"></div>
                    <AlertCircle size={48} className="relative mx-auto text-danger mb-4" />
                    <h2 className="relative text-xl font-bold text-foreground mb-2">Report Not Found</h2>
                    <p className="relative text-muted-foreground text-sm mb-6">{error || "This analysis doesn't exist."}</p>
                    <Link
                        to="/dashboard"
                        className="relative bg-primary px-5 py-2.5 rounded-xl text-sm font-semibold text-primary-foreground inline-block shadow-[0_0_18px_rgba(99,102,241,0.5)] hover:shadow-[0_0_28px_rgba(99,102,241,0.7)] transition-all"
        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="relative text-center bg-card border border-danger/20 rounded-2xl p-10 shadow-[0_0_35px_-10px_rgba(239,68,68,0.35)] overflow-hidden">
                    <div className="absolute -top-16 -right-16 w-40 h-40 bg-danger/15 blur-[60px] rounded-full pointer-events-none"></div>
                    <AlertCircle size={48} className="relative mx-auto text-danger mb-4" />
                    <h2 className="relative text-xl font-bold text-foreground mb-2">Analysis Failed</h2>
                    <p className="relative text-muted-foreground text-sm mb-6">The AI model might be down. Please try again later.</p>
                    <Link
                        to="/analyze"
                        className="relative bg-primary px-5 py-2.5 rounded-xl text-sm font-semibold text-primary-foreground inline-block shadow-[0_0_18px_rgba(99,102,241,0.5)] hover:shadow-[0_0_28px_rgba(99,102,241,0.7)] transition-all"
                        style={{ color: "var(--background)" }}
    ...
    return (
        <div className="relative min-h-screen pt-16 md:pt-24 bg-background overflow-hidden">
            {/* Ambient glow */}
            <div className="absolute top-24 left-1/3 w-125 h-75 bg-primary/10 blur-[130px] rounded-full -z-1 pointer-events-none"></div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                {/* Score Hero */}
                <div className="relative bg-card border border-primary/20 rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_0_35px_-12px_rgba(99,102,241,0.4)] overflow-hidden" style={{ animationDelay: "100ms" }}>
                    <div className="absolute -top-16 -left-16 w-48 h-48 bg-primary/10 blur-[70px] rounded-full pointer-events-none"></div>
                        ...
                        <div className="flex-1 w-full">
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div key={cat.label} className={`rounded-xl p-4 border text-center hover:-translate-y-0.5 transition-transform ${getScoreBgClass(cat.value)}`}>
                            ...
                            <div className="grid grid-cols-3 gap-3 mt-4">
                                <div className="bg-muted/30 border border-border rounded-xl p-3 text-center hover:border-primary/25 transition-colors">
                    ...
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all whitespace-nowrap ${
                                activeTab === tab.id ? "bg-primary text-primary-foreground shadow-[0_0_18px_-4px_rgba(99,102,241,0.6)]" : "bg-card border border-border text-muted-foreground hover:text-foreground hover:border-primary/25"
                            }`}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6 hover:border-primary/20 transition-colors">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <div className="severity-critical rounded-xl p-4 text-center shadow-[0_0_15px_-6px_rgba(239,68,68,0.4)]">
                                        <p className="text-2xl font-bold">{criticalCount}</p>
                                        <p className="text-xs mt-1">Critical</p>
                                    </div>
                                    <div className="severity-warning rounded-xl p-4 text-center shadow-[0_0_15px_-6px_rgba(245,158,11,0.4)]">
                                        <p className="text-2xl font-bold">{warningCount}</p>
                                        <p className="text-xs mt-1">Warnings</p>
                                    </div>
                                    <div className="severity-info rounded-xl p-4 text-center shadow-[0_0_15px_-6px_rgba(99,102,241,0.4)]">
                            ...
                            <div className="space-y-6">
                                <div className="bg-card border border-border rounded-2xl p-6 hover:border-primary/20 transition-colors">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <div className="glass border border-border rounded-xl p-4 text-center hover:shadow-[0_0_15px_-6px_rgba(99,102,241,0.4)] transition-shadow">
                                ...
                                <div className="bg-card border border-border rounded-2xl p-6 hover:border-primary/20 transition-colors">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        ...
                                        <div className="glass border border-success/20 rounded-xl p-4 text-center shadow-[0_0_15px_-6px_rgba(16,185,129,0.4)]">
                                        ...
                                        <div className={`glass border rounded-xl p-4 text-center ${analysis.images.missingAlt > 0 ? "border-danger/20 shadow-[0_0_15px_-6px_rgba(239,68,68,0.4)]" : "border-success/20"}`}>
                                            ...
                                            <div key={tag} className="flex items-center gap-3">
                                                ...
                                                <div className="flex-1 h-6 rounded-lg bg-muted/40 overflow-hidden">
                                                    <div
                                                        ...
                                                        style={{ width: `${(count / maxBar) * 100}%`, minWidth: count > 0 ? "20px" : "0", boxShadow: count > 0 ? "0 0 10px rgba(99,102,241,0.5)" : undefined }}
                                                    />
                                                </div>
                                ...
                                {analysis.headings.h1Texts.length > 0 && (
                                    <div className="mt-4 p-3 rounded-xl bg-muted/30 border border-border">
                                        ...
                                        {analysis.headings.h1Texts.map((text, i) => (
                                            <p key={i} className="text-sm text-foreground/90 truncate">
                                                {text}
                                            </p>
                                        ))}
                                    </div>
                                        ...
                                        {analysis.keywords.map((kw, i) => (
                                            <div key={kw.word} className="flex items-center gap-3">
                                                ...
                                                <div className="w-16 h-1.5 rounded-full bg-muted/40 overflow-hidden">
                                                    <div className="h-full rounded-full bg-accent" style={{ width: `${Math.min(kw.density * 10, 100)}%`, boxShadow: "0 0 8px rgba(99,102,241,0.5)" }} />
                                                </div>
                        ...
                        <div className="bg-card border border-border rounded-2xl p-6">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={meta.label} className="bg-muted/50 border border-border rounded-xl p-4 hover:border-primary/20 transition-colors">
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="text-sm font-medium text-foreground">{meta.label}</span>
                                            <div className="flex items-center gap-2">
                                                {meta.len !== undefined && <span className="text-xs text-muted-foreground">{meta.len} chars</span>}
                                                {meta.value ? (
                                                    <span className="w-2 h-2 rounded-full bg-success shadow-[0_0_8px_rgba(16,185,129,0.7)]" />
                                                ) : (
                                                    <span className="w-2 h-2 rounded-full bg-danger shadow-[0_0_8px_rgba(239,68,68,0.7)]" />
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        {meta.ideal && <p className="text-[10px] text-muted-foreground/70 mt-1">Ideal: {meta.ideal}</p>}
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    {activeTab === "content" && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-card border border-border rounded-2xl p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center p-3 bg-muted/50 border border-border rounded-xl hover:border-primary/20 transition-colors">
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6">
                                ...
                                <div className="space-y-2">
                                    {["h1", "h2", "h3", "h4", "h5", "h6"].map((tag, i) => {
                                        const count = analysis.headings[tag as keyof typeof analysis.headings] as number;
                                        return (
                                            <div key={tag} className="flex items-center gap-3 p-2.5 bg-muted/30 border border-border rounded-lg hover:border-primary/25 transition-colors" style={{ paddingLeft: `${i * 12 + 12}px` }}>
                            ...
                            {analysis.issues.length > 0 ? (
                                <>
                                    ...
                                    <div className="flex items-center gap-3 mb-4 flex-wrap">
                                        ...
                                        <span className="severity-critical px-2.5 py-1 rounded-full text-xs font-semibold shadow-[0_0_12px_-4px_rgba(239,68,68,0.5)]">{criticalCount} Critical</span>
                                        <span className="severity-warning px-2.5 py-1 rounded-full text-xs font-semibold shadow-[0_0_12px_-4px_rgba(245,158,11,0.5)]">{warningCount} Warnings</span>
                                        <span className="severity-info px-2.5 py-1 rounded-full text-xs font-semibold shadow-[0_0_12px_-4px_rgba(99,102,241,0.5)]">{infoCount} Info</span>
                                    </div>
                                ...
                                <div className="relative bg-card border border-success/20 rounded-2xl p-12 text-center shadow-[0_0_35px_-12px_rgba(16,185,129,0.4)] overflow-hidden">
                                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-60 h-40 bg-success/10 blur-[80px] rounded-full pointer-events-none"></div>
                                    <div className="relative w-16 h-16 rounded-full bg-success/10 flex items-center justify-center mx-auto mb-4 shadow-[0_0_20px_-5px_rgba(16,185,129,0.5)]">
                                        <AlertCircle size={32} className="text-success" />
                                    </div>
                                    <h3 className="relative text-lg font-semibold text-foreground mb-2">No Issues Found!</h3>
                                    <p className="relative text-sm text-muted-foreground">Your website is following SEO best practices.</p>
                                </div>
                            )}
                        </div>
                    )}
