    ...
    return (
        <section className="max-w-2xl mx-auto px-4 py-40 sm:py-44 min-h-screen text-center">
            ...
            <form onSubmit={handleQuickAnalyze} className="max-w-2xl mx-auto relative">
                <div className="bg-card border border-border rounded-full px-2 py-1.5 flex items-center gap-2 shadow-[0_0_30px_-8px_rgba(99,102,241,0.4)] focus-within:border-primary/50 focus-within:shadow-[0_0_40px_-5px_rgba(99,102,241,0.6)] transition-all duration-300 animate-pulse-glow">
                    ...
                    <button type="submit" className="relative bg-primary px-5 py-2.5 rounded-full text-primary-foreground text-sm hover:opacity-90 transition-all shrink-0 flex items-center gap-2 shadow-[0_0_20px_rgba(99,102,241,0.6)] hover:shadow-[0_0_30px_rgba(99,102,241,0.8)] overflow-hidden group" id="hero-analyze-btn" style={{ color: "var(--background)" }}>
